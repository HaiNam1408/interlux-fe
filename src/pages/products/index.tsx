...
import { getAllProducts, getAllProductsByCategory } from "@apis/product.api";
...
const Products = () => {
  ...
  const idCategory = useSelector(
    (state: RootState) => state.product.idCategory
  );
  ...
  const sortDirection = useSelector(
    (state: RootState) => state.product.sortDirection
  );
